...
5. 补齐 forum reply 相关计数、最近回复、section 最近发帖时间闭环。
...
- forum topic 回复后与删除回复后，`replyCount/lastReplyAt/lastReplyUserId` 以及 section 侧 `replyCount/lastPostAt/lastTopicId` 能闭环更新。

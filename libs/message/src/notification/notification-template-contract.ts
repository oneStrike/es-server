import type { CanonicalNotificationTemplateContractMap } from './notification-template-contract.type'
import type { MessageNotificationCategoryKey } from './notification.type'

export type {
  CanonicalNotificationTemplateContract,
  CanonicalNotificationTemplateContractMap,
} from './notification-template-contract.type'

const CANONICAL_NOTIFICATION_TEMPLATE_CONTRACT_MAP: CanonicalNotificationTemplateContractMap =
  {
    comment_reply: {

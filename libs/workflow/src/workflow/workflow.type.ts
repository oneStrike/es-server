...
/** 工作流事件记录映射字段。 */
export type WorkflowRecordEventRow = Pick<
  WorkflowEventSelect,
  'id' | 'workflowAttemptId' | 'eventType' | 'eventCode' | 'detail' | 'createdAt'
>

/** 工作流 attempt 标识映射字段。 */
export type WorkflowRecordAttemptRow = Pick<
  WorkflowAttemptSelect,
  'attemptId' | 'attemptNo'
>

/** 工作流事件 DTO 映射字段。 */
export type WorkflowEventDtoRow = Pick<
  WorkflowEventSelect,

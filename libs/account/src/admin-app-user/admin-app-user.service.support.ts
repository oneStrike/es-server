...
import type { AdminAppUserCountDto } from './dto/admin-app-user.dto'
import {
 ...
 *
 * 统一收口管理端 APP 用户聚合的底层表访问、权限校验、计数映射与通用 helper，
 * 供 account read-model owner 内的 query / command service 复用。
 */
export abstract class AdminAppUserServiceSupport {
  constructor(

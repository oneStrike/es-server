 ...
 * - 统一约束目标类型与目标ID组合
 */
export type FavoriteTargetInput = Pick<UserFavoriteSelect, 'targetId'> & {
...
export type FavoriteRecordInput = FavoriteTargetInput &
  Pick<UserFavoriteSelect, 'userId'>
 ...
 */
export type FavoritePageQuery = Pick<UserFavoriteSelect, 'userId'> & {
  pageIndex?: number
  pageSize?: number
}

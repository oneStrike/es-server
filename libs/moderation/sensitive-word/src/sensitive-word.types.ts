...
import type { BaseSensitiveWordHitDto } from './dto/sensitive-word.dto'
import type {
  MatchModeEnum,
...
/** 内部富命中结果。 */
export interface SensitiveWordDetectedHit extends BaseSensitiveWordHitDto {
...
export interface SensitiveWordInternalDetectResult {
  ...
  publicHits: BaseSensitiveWordHitDto[]

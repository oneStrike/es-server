...
> implements ITokenStorageService {
  ...
  protected abstract createOne(data: TokenSessionCreateInput): Promise<T>

  /** 批量创建 token 记录，返回写入条数。 */
  protected abstract createManyItems(
    data: TokenSessionCreateInput[],
  ): Promise<number>

 ...
 */
export const forumModeratorApplication = snakeCase.table(
  ...
  (table) => [
     ...
     * 申请人与板块唯一约束
     */
    unique('forum_moderator_application_applicant_id_section_id_key').on(
      table.applicantId,
      table.sectionId,
    ),
    /**
...
export type ForumModeratorApplicationSelect =
  typeof forumModeratorApplication.$inferSelect
export type ForumModeratorApplicationInsert =
  typeof forumModeratorApplication.$inferInsert

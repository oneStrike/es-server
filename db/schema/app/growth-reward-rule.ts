 ...
 */
export const growthRewardRule = pgTable('growth_reward_rule', {
  /** 主键 ID。 */
  ...
  check(
    'growth_reward_rule_delta_positive_chk',
    sql`${table.delta} > 0`,
  ),
])

export type GrowthRewardRule = typeof growthRewardRule.$inferSelect
export type GrowthRewardRuleSelect = GrowthRewardRule

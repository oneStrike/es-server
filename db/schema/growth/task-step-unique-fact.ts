...
export const taskStepUniqueFact = snakeCase.table(
  ...
  (table) => [
    ...
    check(
      'task_step_unique_fact_event_code_valid_chk',
      sql`${table.firstEventCode} is null or ${table.firstEventCode} in ${GROWTH_EVENT_CODE_DOMAIN_SQL}`,
    ),
    check(

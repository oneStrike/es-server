...
export const growthRewardSettlement = snakeCase.table(
  ...
  (table) => [
    ...
    check(
      'growth_reward_settlement_event_code_valid_chk',
      sql`${table.eventCode} is null or ${table.eventCode} in ${GROWTH_EVENT_CODE_DOMAIN_SQL}`,
    ),
    check(
...
export type GrowthRewardSettlementSelect =
  typeof growthRewardSettlement.$inferSelect
export type GrowthRewardSettlementInsert =
  typeof growthRewardSettlement.$inferInsert

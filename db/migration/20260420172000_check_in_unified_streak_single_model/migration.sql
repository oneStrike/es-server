...
ALTER TABLE "check_in_streak_config"
  ADD CONSTRAINT "check_in_streak_config_version_key" UNIQUE ("version"),
  ADD CONSTRAINT "check_in_streak_config_version_positive_chk" CHECK ("version" > 0),
  ADD CONSTRAINT "check_in_streak_config_status_valid_chk" CHECK ("status" in (0, 1, 2, 3, 4)),
  ADD CONSTRAINT "check_in_streak_config_publish_strategy_valid_chk" CHECK ("publish_strategy" in (1, 2, 3)),
  ADD CONSTRAINT "check_in_streak_config_effective_window_valid_chk" CHECK ("effective_to" is null or "effective_to" > "effective_from");

CREATE INDEX "check_in_streak_config_status_idx" ON "check_in_streak_config" ("status");
CREATE INDEX "check_in_streak_config_effective_from_idx" ON "check_in_streak_config" ("effective_from");
CREATE INDEX "check_in_streak_config_effective_to_idx" ON "check_in_streak_config" ("effective_to");
...
ALTER TABLE "check_in_streak_rule"
  ADD CONSTRAINT "check_in_streak_rule_config_streak_days_key" UNIQUE ("config_id", "streak_days"),
  ADD CONSTRAINT "check_in_streak_rule_config_rule_code_key" UNIQUE ("config_id", "rule_code"),
  ADD CONSTRAINT "check_in_streak_rule_config_id_positive_chk" CHECK ("config_id" > 0),
  ADD CONSTRAINT "check_in_streak_rule_streak_days_positive_chk" CHECK ("streak_days" > 0),
  ADD CONSTRAINT "check_in_streak_rule_status_valid_chk" CHECK ("status" in (0, 1)),
  ADD CONSTRAINT "check_in_streak_rule_sort_order_non_negative_chk" CHECK ("sort_order" >= 0),
  ADD CONSTRAINT "check_in_streak_rule_rule_code_not_blank_chk" CHECK (btrim("rule_code") <> '');

CREATE INDEX "check_in_streak_rule_config_id_idx" ON "check_in_streak_rule" ("config_id");
...
ALTER TABLE "check_in_streak_progress"
  ADD CONSTRAINT "check_in_streak_progress_user_id_key" UNIQUE ("user_id"),
...
ALTER TABLE "check_in_streak_grant"
  ...
  ADD CONSTRAINT "check_in_streak_grant_config_id_positive_chk" CHECK ("config_id" > 0),
...
CREATE INDEX "check_in_streak_grant_config_id_idx" ON "check_in_streak_grant" ("config_id");

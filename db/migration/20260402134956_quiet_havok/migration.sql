...
CREATE TABLE "check_in_cycle" (
	...
	CONSTRAINT "check_in_cycle_version_non_negative_chk" CHECK ("version" >= 0),
	CONSTRAINT "check_in_cycle_last_signed_date_in_cycle_chk" CHECK ("last_signed_date" is null or ("last_signed_date" >= "cycle_start_date" and "last_signed_date" <= "cycle_end_date")),
	CONSTRAINT "check_in_cycle_current_streak_not_gt_signed_count_chk" CHECK ("current_streak" <= "signed_count"),
	CONSTRAINT "check_in_cycle_makeup_used_count_not_gt_signed_count_chk" CHECK ("makeup_used_count" <= "signed_count"),
	CONSTRAINT "check_in_cycle_signed_count_not_gt_cycle_days_chk" CHECK ("signed_count" <= ("cycle_end_date" - "cycle_start_date" + 1)),
...
CREATE TABLE "check_in_plan" (
	...
	CONSTRAINT "check_in_plan_status_valid_chk" CHECK ("status" in (0, 1, 2, 3)),
	CONSTRAINT "check_in_plan_cycle_type_valid_chk" CHECK ("cycle_type" in ('daily', 'weekly', 'monthly')),
	CONSTRAINT "check_in_plan_version_positive_chk" CHECK ("version" > 0),
	CONSTRAINT "check_in_plan_date_range_valid_chk" CHECK ("end_date" is null or "end_date" >= "start_date")
);
--> statement-breakpoint
CREATE TABLE "check_in_record" (
	...
	CONSTRAINT "check_in_record_reward_status_valid_chk" CHECK ("reward_status" is null or "reward_status" in (0, 1, 2)),
	CONSTRAINT "check_in_record_reward_result_type_valid_chk" CHECK ("reward_result_type" is null or "reward_result_type" in (1, 2, 3)),
	CONSTRAINT "check_in_record_operator_type_valid_chk" CHECK ("operator_type" in (1, 2, 3)),
	CONSTRAINT "check_in_record_reward_state_consistent_chk" CHECK ((
...
CREATE TABLE "check_in_streak_reward_grant" (
	...
	CONSTRAINT "check_in_streak_grant_status_valid_chk" CHECK ("grant_status" in (0, 1, 2)),
	CONSTRAINT "check_in_streak_grant_result_type_valid_chk" CHECK ("grant_result_type" is null or "grant_result_type" in (1, 2, 3)),
	CONSTRAINT "check_in_streak_grant_state_consistent_chk" CHECK ((
      "grant_status" = 0
...
CREATE TABLE "check_in_streak_reward_rule" (
	...
	CONSTRAINT "check_in_streak_rule_status_valid_chk" CHECK ("status" in (0, 1))
);
--> statement-breakpoint
...
CREATE TABLE "task" (
	...
	"objective_type" smallint DEFAULT 1 NOT NULL,
	"event_code" integer,
	...
	"updated_at" timestamp(6) with time zone NOT NULL,
	"deleted_at" timestamp(6) with time zone,
	CONSTRAINT "task_target_count_positive_chk" CHECK ("target_count" > 0)
);
--> statement-breakpoint
CREATE TABLE "task_assignment" (
	...
	"cycle_key" varchar(32) NOT NULL,
	"status" smallint NOT NULL,
	"reward_status" smallint DEFAULT 0 NOT NULL,
	"reward_result_type" smallint,
	...
	"reward_settled_at" timestamp(6) with time zone,
	"reward_ledger_ids" integer[] DEFAULT ARRAY[]::integer[] NOT NULL,
	"last_reward_error" varchar(500),
	"created_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp(6) with time zone NOT NULL,
	"deleted_at" timestamp(6) with time zone,
	CONSTRAINT "task_assignment_task_id_user_id_cycle_key_key" UNIQUE("task_id","user_id","cycle_key"),
	CONSTRAINT "task_assignment_target_positive_chk" CHECK ("target" > 0)
);
--> statement-breakpoint
CREATE TABLE "task_progress_log" (
	...
	"event_occurred_at" timestamp(6) with time zone,
	"context" jsonb,
	"created_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "task_progress_log_assignment_id_event_biz_key_key" UNIQUE("assignment_id","event_biz_key")
);
--> statement-breakpoint
...
CREATE TABLE "forum_topic_tag" (
	...
	"tag_id" integer,
	"created_at" timestamp(6) with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "forum_topic_tag_pkey" PRIMARY KEY("topic_id","tag_id")
);
--> statement-breakpoint
...
CREATE INDEX "check_in_plan_status_idx" ON "check_in_plan" ("status");--> statement-breakpoint
CREATE INDEX "check_in_plan_start_date_idx" ON "check_in_plan" ("start_date");--> statement-breakpoint
CREATE INDEX "check_in_plan_end_date_idx" ON "check_in_plan" ("end_date");--> statement-breakpoint
...
CREATE INDEX "check_in_streak_rule_deleted_at_idx" ON "check_in_streak_reward_rule" ("deleted_at");--> statement-breakpoint
...
CREATE INDEX "task_progress_log_event_code_created_at_idx" ON "task_progress_log" ("event_code","created_at");--> statement-breakpoint
...
CREATE INDEX "forum_topic_tag_tag_id_created_at_idx" ON "forum_topic_tag" ("tag_id","created_at" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX "chat_conversation_member_user_id_joined_at_idx" ON "chat_conversation_member" ("user_id","joined_at","conversation_id");--> statement-breakpoint
...
CREATE INDEX "notification_delivery_biz_key_idx" ON "notification_delivery" ("biz_key");--> statement-breakpoint

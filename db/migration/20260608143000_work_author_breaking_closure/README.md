...
- `work_author_relation.work_id` and `author_id` stay as indexed scalar columns; this repository intentionally does not create database foreign keys.
...
- Invalid data fails the migration before constraints and indexes are changed.

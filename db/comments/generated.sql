...
COMMENT ON COLUMN "public"."task"."id" IS E'主键id';
COMMENT ON COLUMN "public"."task"."code" IS E'任务编码';
...
COMMENT ON COLUMN "public"."task"."status" IS E'任务状态';
...
COMMENT ON COLUMN "public"."task"."created_by_id" IS E'创建人ID';
COMMENT ON COLUMN "public"."task"."updated_by_id" IS E'更新人ID';
COMMENT ON COLUMN "public"."task"."created_at" IS E'创建时间';
COMMENT ON COLUMN "public"."task"."updated_at" IS E'更新时间';
COMMENT ON COLUMN "public"."task"."deleted_at" IS E'删除时间';
COMMENT ON TABLE "public"."task_assignment" IS E'任务分配记录';
COMMENT ON COLUMN "public"."task_assignment"."id" IS E'主键id';
COMMENT ON COLUMN "public"."task_assignment"."task_id" IS E'任务ID';
COMMENT ON COLUMN "public"."task_assignment"."user_id" IS E'用户ID';
COMMENT ON COLUMN "public"."task_assignment"."cycle_key" IS E'周期标识';
COMMENT ON COLUMN "public"."task_assignment"."status" IS E'分配状态（PENDING=已领取待开始，IN_PROGRESS=进行中）';
...
COMMENT ON COLUMN "public"."task_assignment"."reward_ledger_ids" IS E'本次奖励关联到账本记录ID列表';
COMMENT ON COLUMN "public"."task_assignment"."last_reward_error" IS E'上次奖励失败原因';
COMMENT ON COLUMN "public"."task_assignment"."created_at" IS E'创建时间';
COMMENT ON COLUMN "public"."task_assignment"."updated_at" IS E'更新时间';
COMMENT ON COLUMN "public"."task_assignment"."deleted_at" IS E'删除时间';
COMMENT ON TABLE "public"."task_progress_log" IS E'任务进度日志';
COMMENT ON COLUMN "public"."task_progress_log"."id" IS E'主键id';
COMMENT ON COLUMN "public"."task_progress_log"."assignment_id" IS E'分配记录ID';
COMMENT ON COLUMN "public"."task_progress_log"."user_id" IS E'用户ID';
...
COMMENT ON COLUMN "public"."task_progress_log"."created_at" IS E'创建时间';

...
COMMENT ON TABLE "public"."content_import_event_link" IS E'内容导入事件投影表。\n将通用 workflow_event 映射到内容导入任务、条目与条目 attempt。';
COMMENT ON COLUMN "public"."content_import_event_link"."id" IS E'主键 ID。';
COMMENT ON COLUMN "public"."content_import_event_link"."workflow_event_id" IS E'工作流事件内部 ID。';
COMMENT ON COLUMN "public"."content_import_event_link"."content_import_job_id" IS E'内容导入任务内部 ID。';
COMMENT ON COLUMN "public"."content_import_event_link"."content_import_item_id" IS E'内容导入条目内部 ID。';
COMMENT ON COLUMN "public"."content_import_event_link"."content_import_item_attempt_id" IS E'内容导入条目 attempt 内部 ID。';
...
COMMENT ON COLUMN "public"."content_import_item"."last_error_message" IS E'最近错误信息。';
...
COMMENT ON COLUMN "public"."content_import_item_attempt"."status" IS E'条目 attempt 状态（1=待处理，2=处理中，3=成功，4=失败，5=已跳过）。';
...
COMMENT ON COLUMN "public"."content_import_item_attempt"."error_message" IS E'错误信息。';
...
COMMENT ON COLUMN "public"."workflow_attempt"."error_message" IS E'错误信息。';
...
COMMENT ON COLUMN "public"."workflow_event"."message" IS E'事件文案。';
...
COMMENT ON COLUMN "public"."workflow_job"."progress_message" IS E'进度文案。';

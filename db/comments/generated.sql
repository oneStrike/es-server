...
COMMENT ON TABLE "public"."check_in_streak_config" IS E'连续签到配置版本。\n\n系统任一时刻只允许一套连续签到规则对运行时生效；历史版本仅用于审计和奖励归因。';
COMMENT ON COLUMN "public"."check_in_streak_config"."id" IS E'配置版本主键。';
COMMENT ON COLUMN "public"."check_in_streak_config"."version" IS E'版本号。';
COMMENT ON COLUMN "public"."check_in_streak_config"."status" IS E'配置状态（0=草稿；1=已排期；2=生效中；3=已过期；4=已终止）。';
COMMENT ON COLUMN "public"."check_in_streak_config"."publish_strategy" IS E'发布策略（1=立即生效；2=次日生效；3=指定时间生效）。';
COMMENT ON COLUMN "public"."check_in_streak_config"."effective_from" IS E'生效开始时间。';
COMMENT ON COLUMN "public"."check_in_streak_config"."effective_to" IS E'生效结束时间。';
COMMENT ON COLUMN "public"."check_in_streak_config"."updated_by_id" IS E'最近更新人 ID。';
COMMENT ON COLUMN "public"."check_in_streak_config"."created_at" IS E'创建时间。';
COMMENT ON COLUMN "public"."check_in_streak_config"."updated_at" IS E'最近更新时间。';
...
COMMENT ON COLUMN "public"."check_in_streak_grant"."config_id" IS E'归属配置版本 ID。';
...
COMMENT ON COLUMN "public"."check_in_streak_rule"."config_id" IS E'所属连续签到配置 ID。';
...
COMMENT ON COLUMN "public"."check_in_streak_rule"."status" IS E'规则状态（0=停用；1=启用）。';
COMMENT ON COLUMN "public"."check_in_streak_rule"."sort_order" IS E'排序值。0=默认顺序。';

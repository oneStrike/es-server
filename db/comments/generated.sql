...
COMMENT ON TABLE "public"."check_in_activity_streak_rule" IS E'活动连续签到按天规则。\n\n每条记录表达一个活动下“第 N 天”的奖励规则。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."id" IS E'规则主键。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."activity_id" IS E'所属活动 ID。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."rule_code" IS E'规则稳定编码。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."streak_days" IS E'连续签到天数。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."repeatable" IS E'是否允许重复发放。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."status" IS E'规则状态（0=停用；1=启用）。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."created_at" IS E'创建时间。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule"."updated_at" IS E'最近更新时间。';
COMMENT ON TABLE "public"."check_in_activity_streak_rule_reward_item" IS E'活动连续签到规则奖励项。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."id" IS E'奖励项主键。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."rule_id" IS E'所属规则 ID。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."asset_type" IS E'奖励资产类型（1=积分；2=经验）。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."asset_key" IS E'奖励资产键。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."amount" IS E'奖励数量。';
COMMENT ON COLUMN "public"."check_in_activity_streak_rule_reward_item"."sort_order" IS E'排序值。0=默认顺序。';
...
COMMENT ON TABLE "public"."check_in_daily_streak_rule" IS E'日常连续签到按天规则。\n\n每条记录表达一个配置版本下“第 N 天”的奖励规则。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."id" IS E'规则主键。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."config_id" IS E'所属日常连续签到配置 ID。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."rule_code" IS E'规则稳定编码。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."streak_days" IS E'连续签到天数。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."repeatable" IS E'是否允许重复发放。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."status" IS E'规则状态（0=停用；1=启用）。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."created_at" IS E'创建时间。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule"."updated_at" IS E'最近更新时间。';
COMMENT ON TABLE "public"."check_in_daily_streak_rule_reward_item" IS E'日常连续签到规则奖励项。\n\n一条奖励项一条记录，按 `sortOrder` 保持展示顺序。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."id" IS E'奖励项主键。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."rule_id" IS E'所属规则 ID。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."asset_type" IS E'奖励资产类型（1=积分；2=经验）。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."asset_key" IS E'奖励资产键。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."amount" IS E'奖励数量。';
COMMENT ON COLUMN "public"."check_in_daily_streak_rule_reward_item"."sort_order" IS E'排序值。0=默认顺序。';
...
COMMENT ON COLUMN "public"."check_in_streak_grant"."daily_rule_id" IS E'日常连续签到规则 ID。';
COMMENT ON COLUMN "public"."check_in_streak_grant"."activity_id" IS E'活动连续签到活动 ID。';
COMMENT ON COLUMN "public"."check_in_streak_grant"."activity_rule_id" IS E'活动连续签到规则 ID。';

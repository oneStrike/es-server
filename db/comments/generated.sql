...
COMMENT ON TABLE "public"."check_in_streak_progress" IS E'用户连续奖励进度。\n\n每个用户只绑定当前一个有效轮次配置，进度切换只能发生在首次绑定、迁移初始化\n或当前轮完成后的自动切轮；若绑定轮次已归档，则继续沿该轮持久化的后继链路推进。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."id" IS E'连续奖励进度主键。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."user_id" IS E'归属用户 ID。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."round_config_id" IS E'当前绑定的轮次配置 ID。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."round_iteration" IS E'当前轮次迭代号。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."current_streak" IS E'当前连续天数。';
COMMENT ON COLUMN "public"."check_in_streak_progress"."round_started_at" IS E'当前轮开始日期。';
...
COMMENT ON COLUMN "public"."check_in_streak_progress"."updated_at" IS E'更新时间。';
...
COMMENT ON COLUMN "public"."check_in_streak_reward_grant"."round_config_id" IS E'发放时绑定的轮次配置 ID。';
COMMENT ON COLUMN "public"."check_in_streak_reward_grant"."round_iteration" IS E'命中时所在的轮次迭代号。';
...
COMMENT ON COLUMN "public"."check_in_streak_reward_grant"."reward_items" IS E'连续奖励项快照。';
...
COMMENT ON COLUMN "public"."check_in_streak_reward_grant"."reward_settlement_id" IS E'关联的奖励结算事实 ID。';
...
COMMENT ON TABLE "public"."check_in_streak_round_config" IS E'连续奖励轮次配置。\n\n管理当前轮及归档轮的后继接续关系，采用追加式版本模型，不允许原地改写。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."id" IS E'轮次配置主键。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."round_code" IS E'轮次编码。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."version" IS E'同一轮次的版本号。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."status" IS E'状态（0=草稿，1=已启用，2=已归档）。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."reward_rules" IS E'奖励规则列表。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."next_round_strategy" IS E'下一轮切换策略（1=沿用当前规则开启下一轮，2=显式后继轮次）。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."next_round_config_id" IS E'显式后继轮次配置 ID。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."updated_by_id" IS E'最近更新人 ID。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."created_at" IS E'创建时间。';
COMMENT ON COLUMN "public"."check_in_streak_round_config"."updated_at" IS E'更新时间。';

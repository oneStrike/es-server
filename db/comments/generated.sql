...
COMMENT ON TABLE "public"."check_in_date_reward_rule" IS E'签到具体日期奖励规则。\n\n每条规则定义某个计划版本在指定自然日命中的基础奖励配置。\n命中时优先级高于周期模式奖励和计划默认基础奖励。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."id" IS E'具体日期奖励规则主键。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."plan_id" IS E'归属计划 ID。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."plan_version" IS E'归属计划版本号。\n计划奖励解释变化后通过新版本冻结，避免污染历史周期快照。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."reward_date" IS E'命中的具体自然日。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."reward_config" IS E'该自然日的基础奖励配置。\n当前仅支持 `points` / `experience` 正整数，且不允许为空。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."created_at" IS E'规则创建时间。';
COMMENT ON COLUMN "public"."check_in_date_reward_rule"."updated_at" IS E'规则最近更新时间。';
COMMENT ON TABLE "public"."check_in_pattern_reward_rule" IS E'签到周期模式奖励规则。\n\n规则可表达“每周固定星期几”“每月固定几号”“每月最后一天”三类命中模式，\n优先级低于具体日期奖励，高于计划默认基础奖励。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."id" IS E'周期模式奖励规则主键。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."plan_id" IS E'归属计划 ID。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."plan_version" IS E'归属计划版本号。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."pattern_type" IS E'规则模式类型。\n仅允许 `WEEKDAY` / `MONTH_DAY` / `MONTH_LAST_DAY`。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."weekday" IS E'星期值。\n仅当 `patternType=WEEKDAY` 时使用，1=周一，7=周日。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."month_day" IS E'每月几号。\n仅当 `patternType=MONTH_DAY` 时使用，取值范围为 1..31。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."reward_config" IS E'命中后的基础奖励配置。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."created_at" IS E'规则创建时间。';
COMMENT ON COLUMN "public"."check_in_pattern_reward_rule"."updated_at" IS E'规则最近更新时间。';
...
COMMENT ON COLUMN "public"."check_in_record"."resolved_reward_rule_id" IS E'本次基础奖励命中的规则 ID。\n与 `resolvedRewardSourceType` 组合解释的软引用；命中默认基础奖励时为空。';
...
COMMENT ON COLUMN "public"."user_level_rule"."discount" IS E'积分购买折扣（0-1之间的小数，0表示不打折）';
...
COMMENT ON COLUMN "public"."user_purchase_record"."price" IS E'购买价格（实际支付金额）';

...
COMMENT ON COLUMN "public"."check_in_daily_reward_rule"."day_index" IS E'奖励天序号。\n`weekly` 计划只允许 `1..7`，`monthly` 计划只允许 `1..31`，服务层再按周期类型做更严校验。';
COMMENT ON COLUMN "public"."check_in_daily_reward_rule"."reward_config" IS E'当天基础奖励配置。\n当前仅支持 `points` / `experience` 正整数，且不允许为空。';
COMMENT ON COLUMN "public"."check_in_daily_reward_rule"."created_at" IS E'规则创建时间。';
COMMENT ON COLUMN "public"."check_in_daily_reward_rule"."updated_at" IS E'规则最近更新时间。';

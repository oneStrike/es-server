...
const LEVEL_FIXTURES = [
  ...
  },
  {
    name: '论坛新手',
    requiredExperience: 0,
    description: '用于论坛互动的基础等级。',
    icon: 'https://static.example.com/levels/forum-lv1.svg',
    color: '#5B8FF9',
    sortOrder: 1,
    business: 'forum',
    dailyTopicLimit: 2,
  ...
  },
  {
    name: '论坛活跃用户',
    requiredExperience: 200,
    description: '用于论坛互动的活跃等级。',
    icon: 'https://static.example.com/levels/forum-lv2.svg',
    color: '#36CFC9',
    sortOrder: 2,
    business: 'forum',
    dailyTopicLimit: 5,
  ...
  },
  {
    name: '论坛资深用户',
    requiredExperience: 600,
    description: '用于论坛互动的资深等级。',
    icon: 'https://static.example.com/levels/forum-lv3.svg',
    color: '#F6BD16',
    sortOrder: 3,
    business: 'forum',
    dailyTopicLimit: 10,
...
const PAYMENT_PROVIDER_CONFIG_FIXTURES = [
  {
    ...
    appId: 'mandu-alipay-2021',
    mchId: 'mandu-alipay-mch',
    ...
    rootCertRef: null,
    credentialVersionRef: 'mandu://payment/alipay/v1',
    configMetadata: {
      keyFingerprint: 'mandu-alipay',
  ...
  },
  {
    ...
    clientAppKey: 'default-app',
    configName: '演示微信支付配置',
    appId: 'mandu-wechat-2021',
    mchId: 'mandu-wechat-mch',
    ...
    platformCertRef: null,
    rootCertRef: null,
    credentialVersionRef: 'mandu://payment/wechat/v1',
    configMetadata: {
      keyFingerprint: 'mandu-wechat',
      wechatApiV3KeyEnvKey: 'ES_PAYMENT_WECHAT_API_V3_KEY',
...
const AD_PROVIDER_CONFIG_FIXTURES = [
  {
    ...
    environment: 1,
    clientAppKey: 'default-app',
    appId: 'mandu-pangle-2021',
    placementKey: 'mandu-reward-feed',
    targetScope: 1,
    dailyLimit: 3,
    configVersion: 1,
    credentialVersionRef: 'mandu://ad/pangle/v1',
    callbackUrl: 'https://example.com/app/ad-reward/verification/create',
    configMetadata: {
      keyFingerprint: 'mandu-pangle',
...
const USER_FIXTURES = Array.from({ length: SEED_USER_COUNT }, (_, index) => {
  ...
  return {
    ...
    emailAddress: `${account}@mandu.com`,
    ...
    banReason: isTemporarilyMuted ? '短期冷静期' : null,
...
const AGREEMENT_FIXTURES = [
  {
    title: '用户协议',
    content: '<h1>用户协议</h1><p>欢迎使用漫读社区。使用本平台即表示你同意以下条款：尊重版权、禁止发布违规内容、遵守社区规范。</p>',
    version: '2026.03',
    isForce: false,
    showInAuth: true,
    isPublished: true,
  ...
  },
  {
    title: '隐私政策',
    content:
      '<h1>隐私政策</h1><p>本平台仅收集必要的账号信息和阅读记录，用于提供个性化推荐和社区互动服务。详见完整隐私政策。</p>',
    version: '2026.03',
    isForce: true,
    showInAuth: true,
    isPublished: true,
...
const ANNOUNCEMENT_FIXTURES = [
  {
    ...
    content: '2026 春季版本更新公告：新增作品推荐、论坛板块优化和消息系统升级。',
    announcementType: 2,
    priorityLevel: 2,
    isPublished: true,
    isPinned: true,
  ...
  },
  {
    ...
    content:
      '社区发言规范更新：请遵守发言规范，禁止人身攻击和违规内容，违规将按等级处理。',
    announcementType: 1,
    priorityLevel: 1,
    isPublished: true,
    isPinned: false,
...
const BADGE_FIXTURES = [
  {
    ...
    icon: 'https://static.example.com/badges/newcomer-start.svg',
    business: 'app',
...
export async function seedAppCoreDomain(db: Db) {
    ...
    for (const definition of seedCouponDefinitions) {
      ...
      const couponFixture = {
        ...
        grantSnapshot: {
          ...
          issuedAt: SEED_TIMELINE.seedAt.toISOString(),
        },
      }
  ...
  const tokenFixtures = [
    {
      ...
      deviceInfo: { device: 'ios', os: 'iOS 18', appVersion: '1.0.0' },
  ...
  const configPayload = {
    ...
    appName: '漫读',
    appDesc: '漫读社区客户端配置。',
    appLogo: 'https://static.example.com/app/logo.png',
    onboardingImage: 'https://static.example.com/app/onboarding.png',
    themeColor: '#0F766E',
    secondaryColor: '#0EA5E9',
    optionalThemeColors: '#0F766E,#0EA5E9,#F59E0B,#EF4444,#8B5CF6',
    enableMaintenanceMode: false,
    maintenanceMessage: '系统当前可用。',
    version: '2026.03.20',
...
export async function seedAppActivityDomain(db: Db) {
  ...
  const purchaseFixtures = [
    {
      ...
      status: 1,
      paymentMethod: 1,
      outTradeNo: 'purchase-aot-chapter-2',
    ...
    },
    {
      ...
      status: 1,
      paymentMethod: 1,
      outTradeNo: 'purchase-byh-chapter-2',
  ...
  const reportFixture = {
    ...
    commentLevel: 1,
    reasonType: 1,
    description: '用于举报流程联调。',
      evidenceUrl: 'https://static.example.com/evidence/report-001.png',
    status: 1,
  }
  ...
  const ledgerFixtures = [
    {
      ...
      targetId: aotChapterTwo.id,
      remark: '漫画章节购买扣虚拟币',
      context: { source: 'system', target: 'aot-chapter-2' },
    },
    {
      userId: userA.id,
      assetType: GrowthAssetTypeEnum.EXPERIENCE,
      ...
      targetId: aotTopic.id,
      remark: '发帖经验奖励',
      context: { source: 'system', target: 'forum-topic' },
    },
  ] as const
  ...
  const auditFixtures = [
    {
      userId: userA.id,
      requestId: 'request-purchase-001',
      bizKey: 'purchase:aot:chapter-2',
      assetType: GrowthAssetTypeEnum.CURRENCY,
      assetKey: 'reading_coin',
      ...
      deltaRequested: -30,
      deltaApplied: -30,
      context: { source: 'system', targetType: 'comic_chapter' },
    },
    {
      userId: userA.id,
      requestId: 'request-topic-001',
      bizKey: 'topic:create:aot',
      assetType: GrowthAssetTypeEnum.EXPERIENCE,
      ...
      deltaRequested: 20,
      deltaApplied: 20,
      context: { source: 'system', targetType: 'forum_topic' },
    },
  ] as const
  ...
  const slotFixtures = [
    {
      ...
      scopeKey: 'purchase:aot:chapter-2',
      usedCount: 1,
    },
    {
      userId: userA.id,
  ...
  if (readChapterTask) {
    const assignmentPayload = {
      ...
      context: { source: 'system', chapterId: aotChapterTwo.id },
      version: 1,
    ...
    const progressLogs = [
      ...
      },
      {
        ...
        userId: userA.id,
        eventCode: 300,
        eventBizKey: 'read:daily_read_chapter:userA:20260320',
        actionType: 2,
        progressSource: 2,
        accepted: true,
        delta: 1,
  ...
  if (forumTask) {
    ...
    const forumAssignmentPayload = {
      ...
      context: { source: 'system', topicId: whiteNightTopic.id },
      version: 1,

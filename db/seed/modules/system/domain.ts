    ...
    for (const itemFixture of dictFixture.items) {
      ...
      if (!existingItem) {
        await db.insert(dictionaryItem).values({
          ...
          isEnabled: true,
          description: `${dictFixture.name} 项`,
        })
      } else {
        await db
...
export async function seedSystemOperationalData(db: Db) {
  ...
  const requestFixtures = [
    ...
    },
    {
      ...
      actionType: 1,
      isSuccess: true,
      content: 'admin create dictionary item',
    ...
    },
    {
      ...
      actionType: 1,
      isSuccess: true,
      content: 'admin create sensitive word',
    ...
    },
    {
      ...
      actionType: 3,
      isSuccess: true,
      content: 'reader purchase chapter',
    ...
    },
    {
      ...
      actionType: 4,
      isSuccess: true,
      content: 'reader browse work list',
    ...
    },
    {
      ...
      actionType: 4,
      isSuccess: true,
      content: 'reader browse work detail',

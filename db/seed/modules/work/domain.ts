...
const CATEGORY_FIXTURES = [
  {
    ...
    contentType: [WorkTypeEnum.COMIC, WorkTypeEnum.NOVEL],
    sortOrder: 1,
    popularity: 120,
  },
  {
  ...
  },
  {
    ...
    contentType: [WorkTypeEnum.NOVEL],
    sortOrder: 5,
    popularity: 80,
  },
] as const
...
const WORK_FIXTURES = [
  {
    ...
    serialStatus: WorkSerialStatusEnum.COMPLETED,
  ...
  },
  {
    ...
    viewRule: WorkViewPermissionEnum.LOGGED_IN,
...
export async function seedWorkDomain(db: Db) {
  ...
  for (const [index, workFixture] of WORK_FIXTURES.entries()) {
    ...
    const workPayload = {
      ...
      ratingCount: workFixture.ratingCount,
    ...
    if (workFixture.type === WorkTypeEnum.COMIC) {
    ...
    for (const [
      ...
      const chapterPayload = {
        ...
        requiredViewLevelId:
          chapterFixture.viewRule === WorkViewPermissionEnum.PURCHASE
            ? requiredLevelId
            : null,

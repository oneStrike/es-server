...
const SECTION_FIXTURES = [
  {
    ...
    icon: 'https://static.example.com/forum/sections/newcomer-icon.png',
    cover: 'https://static.example.com/forum/sections/newcomer-cover.jpg',
    sortOrder: 1,
    topicReviewPolicy: 1,
  },
  {
    ...
    icon: 'https://static.example.com/forum/sections/feedback-icon.png',
    cover: 'https://static.example.com/forum/sections/feedback-cover.jpg',
    sortOrder: 2,
    topicReviewPolicy: 1,
  },
  {
    ...
    icon: 'https://static.example.com/forum/sections/creation-icon.png',
    cover: 'https://static.example.com/forum/sections/creation-cover.jpg',
    sortOrder: 1,
    topicReviewPolicy: 1,
  },
] as const

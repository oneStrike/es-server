...
import type { AdminMenuSelect, AdminRoleSelect } from '@db/schema'
import type { AdminReferencePermission } from './admin-rbac.reference'
import type { AdminCurrentMenuDto } from './dto/admin-rbac.dto'
...
/** 后端装饰器扫描得到的管理端权限定义。 */
export interface AdminPermissionDefinition extends AdminReferencePermission {
...
/** 当前管理员 bootstrap 菜单所需的最小读取行。 */
export type AdminCurrentMenuRow = Pick<
  AdminMenuSelect,
  | 'id'
  | 'code'
  | 'parentId'

...
import { AgreementModule } from './app-settings/agreement/agreement.module'
import { AdminAnnouncementModule } from './app-settings/announcement/announcement.module'
import { AppConfigModule } from './app-settings/config/config.module'
import { AppPageModule } from './app-settings/page/page.module'

import { QueryAppTagPageDto, TagOutputDto } from '@libs/content/tag/dto/tag.dto'
...
export class WorkTagController {
  ...
  async getTagPage(@Query() query: QueryAppTagPageDto) {
    return this.tagService.getAppTagPage(query)
  }
}
